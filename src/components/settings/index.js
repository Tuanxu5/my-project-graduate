          ...
          <>
            <RootStyle {...varSidebar}>
              <Stack
                ...
                sx={{ py: 2, pr: 1, pl: 2.5, fontWeight: 700 }}
              >
              ...
              <Scrollbar sx={{ flexGrow: 1 }}>
                <Stack spacing={3} sx={{ p: 3, fontWeight: 700 }}>
                  <Stack spacing={1.5}>
                  ...
                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Phương Hướng</Typography>
                    <SettingDirection />
                  </Stack>

                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Bố Cục</Typography>
                    <SettingLayout />
                  </Stack>
                  ...
                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Co Giãn</Typography>
                    <SettingStretch />
                  </Stack>
